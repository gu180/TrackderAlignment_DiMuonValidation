...
void Draw_TH1D_forMultiRootFiles(int file_number,
                                 ...
                                 TString label_names[max_file_number],
                                 TString th1d_name,
                                 TString output_name) {
...
void RunMacro() {
  Fitting_GetMassmeanVSvariables("./v6_TrackRefitter_110X_dataRun2_v13.root",
                                 "110X_dataRun2_v13");  //"./merged_v4.root"
  ...
  for (int idx_variable = 0; idx_variable < variables_number; idx_variable++) {
    ...
    Draw_TH1D_forMultiRootFiles(files_number,
                                ...
                                GT_names,
                                th1d_name,
                                Form("meanmass_%s_GTs.pdf", tstring_variables_name[idx_variable].Data()));
    TString th1d_name_entries = Form("th1d_entries_%s", tstring_variables_name[idx_variable].Data());
    Draw_TH1D_forMultiRootFiles(files_number,
                                file_names,
                                GT_names,
                                th1d_name_entries,
                                Form("entries_%s_GTs.pdf", tstring_variables_name[idx_variable].Data()));
  }
